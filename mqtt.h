...
#ifndef esp_buttons_mqtt_h
#define esp_buttons_mqtt_h

extern void configureMQTT(void);
extern void reconnectMQTT(void);
extern void sendButtonMessage(int buttonNumber, bool longPress);

#endif esp_buttons_mqtt_h
